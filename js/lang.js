...
const translations = {
  en: {
    ...
    // About page (updated)
    aboutUsTitle: 'About Us GRABIRON',
    aboutUsSubtitle: 'Grabiron LLC',
    ourStory: 'History',
    rayAttachmentsTitle: 'GRABIRON RAY Attachments',
    ourStoryText1: 'At the beginning of the 1990s, our plant produced equipment and machinery for mining and metallurgical companies.',
    ourStoryText2: 'In 2006, we became subcontractors for Finnish companies manufacturing mining equipment. Since 2006, we have produced manipulators (all metal parts) for hydraulic breakers.',
    ourStoryText3: 'After 9 years of high-quality production, we founded Grabiron LLC jointly with the British company Corrosioneering Group Ltd, while also manufacturing steel structures for excavator attachments for Atlas Copco.',
    qualityStandards: 'Quality Standards',
    qualityStandardsText1: 'For 12 years, our plant has exported products for Sandvik and Metso; recently we also manufacture key parts for Atlas Copco attachments and apply their production standards in our own products (steel structures, rotary mechanisms, bushings, pins, castings, and more).',
    qualityStandardsText2: 'With ISO 9001 certification, deep manufacturing experience, and hydraulics from leading European suppliers, our products are not only on par with European analogs, but in many cases exceed them.',
    qualityStandardsText3: 'We have a full production cycle, including casting and assembly, and purchase only standard components from Italian and Swedish manufacturers.',
    partnershipTitle: 'Partnership and Development',
    partnershipText1: 'Since 2025, we have signed an exclusive agreement with the popular Chinese attachment manufacturer Ray Attachments, significantly expanding the product range sold in Ukraine. Ray Attachments warehouses are available in Ukraine, with warranty service by the Grabiron plant in Dnipro.',
    partnershipText2: 'In recent years, China\'s machine-building industry has made a technological leap, and Ray Attachments has proven in its segment that European quality at a competitive price is the new reality.',
    plantInfoText1: 'Our plant is located in the city of Dnipro.',
    plantInfoText2: 'The total plant area is 45,000 sq. m.',
    plantInfoItem1: '4 production workshops',
    plantInfoItem2: 'Full production cycle',
    aboutGalleryTitle: 'Our Production',
    whyChooseTitle: 'Why Choose Us',
    guaranteeTitle: 'Guarantee Without Problems',
    guaranteeItem1: '12-36 months from GRABIRON factory',
    fastResponseTitle: 'Fast Response',
    fastResponseItem1: 'Response within 2 hours',
    fastResponseItem2: 'Solution within 12 hours',
    businessSupportTitle: 'Business Support',
    businessSupportText: 'Customer multiplier plan',
    stockTitle: 'Finished Goods Warehouse in Ukraine',
    stockItem1: 'Save up to 30% of your costs',
    stockItem2: 'Save 50% of your time',
    stockItem3: 'Make business simple',
    qualityProcessTitle: 'Quality System Process',
    processStep1Title: '1. Raw Material Inspection',
    processStep1Item1: 'Steel chemical composition control',
    processStep1Item2: 'Steel mechanical properties control',
    processStep1Item3: 'Steel sheet hardness control',
    processStep1Item4: 'Raw material size control',
    processStep2Title: '2. Pre-Production Inspection',
    processStep2Item1: 'Cutting parts dimension check',
    processStep3Title: '3. In-Process Inspection',
    processStep3Item1: 'Welding process inspection',
    processStep3Item2: 'Oversized goods inspection',
    processStep3Item3: 'High-precision parts inspection',
    processStep4Title: '4. Hydraulic and Electrical Parts Inspection',
    processStep4Item1: 'Cylinder check before installation',
    processStep4Item2: 'Motor check before installation',
    processStep4Item3: 'Valve check before installation',
    processStep5Title: '5. Assembly Inspection',
    processStep5Item1: 'Assembly process inspection',
    processStep5Item2: 'Functional test of assembly performance',
    processStep5Item3: 'Coating appearance inspection',
    processStep5Item4: 'Coating thickness inspection',
    processStep5Item5: 'Coating adhesion test',
    processStep6Title: '6. Pre-Delivery Inspection',
    processStep6Item1: 'Painting inspection',
    processStep6Item2: 'Readiness inspection',
    processStep6Item3: 'Compliance check with individual requirements',
    processStep6Item4: 'Pre-delivery testing',
    processStep6Item5: 'Packaging inspection',
  ...
  uk: {
    ...
    submit: 'Надіслати',
    officeDept: 'Офіс',
    officeHours: 'Пн-Пт: 8:00 - 18:00',
    salesDept: 'Відділ продажів',
    techSupport: 'Технічна підтримка',
    emailAddressTitle: 'Email та адреса',
    responseWithin2h: 'Відповідь протягом 2 годин',
    ...
    // About page (updated)
    aboutUsTitle: 'Про нас GRABIRON',
    aboutUsSubtitle: 'Компанія ТОВ «Грабірон»',
    ourStory: 'ІСТОРІЯ',
    rayAttachmentsTitle: 'GRABIRON RAY Attachments',
    ourStoryText1: 'На початку 90-х років наш завод виробляв обладнання та машини для гірничодобувних та металургійних компаній.',
    ourStoryText2: 'У 2006 році ми стали субпідрядниками фінських компаній, які виробляють устаткування для гірничої промисловості. З 2006 року ми виробляємо маніпулятори (всі металеві частини) для гідромолотів.',
    ourStoryText3: 'Після 9-ти років виготовлення продукції високої якості, ми створили компанію ТОВ «Грабірон» спільно з британською компанією Corrosioneering Group Ltd, паралельно виготовляючи металоконструкції для навісного обладнання для екскаваторів компанії Atlas Copco.',
    qualityStandards: 'СТАНДАРТИ ЯКОСТІ',
    qualityStandardsText1: 'Протягом 12 років наш завод експортує продукцію для компаній Sandvik і Metso; з недавнього часу ми виробляємо основні частини для навісного обладнання компанії Atlas Copco і застосовуємо виробничі стандарти цих компаній у нашій продукції (металоскладальні конструкції, поворотні механізми, чопи, пальці, лиття та інше).',
    qualityStandardsText2: 'Маючи сертифікат якості ISO 9001, досвід у виробництві даного типу обладнання, використовуючи гідравліку кращих європейських виробників, наш продукт не лише не поступається європейським аналогам, але у більшості випадків перевершує їх.',
    qualityStandardsText3: 'Ми маємо повний цикл виробництва, включаючи лиття і складання. Закуповуємо тільки стандартні комплектуючі у італійських і шведських виробників.',
    partnershipTitle: 'ПАРТНЕРСТВО ТА РОЗВИТОК',
    partnershipText1: 'З 2025 року підписано ексклюзивну угоду з популярним китайським виробником навісного обладнання Ray Attachments, тим самим значно розширивши номенклатуру продукції, що продається в Україні. Є склади продукції Ray Attachments в Україні та гарантійне обслуговування заводом Грабірон у Дніпрі.',
    partnershipText2: 'Загалом китайська машинобудівна галузь здійснила технологічний стрибок за останні роки, і компанія Ray Attachments у своєму сегменті показала, що європейська якість і доступна ціна - це нова реальність.',
    plantInfoText1: 'Наш завод розташований у місті Дніпро.',
    plantInfoText2: 'Загальна площа заводу складає 45000 кв. м.',
    plantInfoItem1: '4 виробничих цеха',
    plantInfoItem2: 'Повний цикл виробництва',
    aboutGalleryTitle: 'Наше виробництво',
    whyChooseTitle: 'ЧОМУ ВАРТО ОБРАТИ НАС',
    guaranteeTitle: 'Гарантія без проблем',
    guaranteeItem1: '12 місяців - 36 місяців від заводу GRABIRON',
    fastResponseTitle: 'Швидке реагування',
    fastResponseItem1: '2 години відповіді',
    fastResponseItem2: 'Надання рішення протягом 12 годин',
    businessSupportTitle: 'Підтримка бізнесу',
    businessSupportText: 'План мультиплікатора клієнтів',
    stockTitle: 'Склад готової продукції в Україні',
    stockItem1: 'Зекономте до 30% своїх витрат',
    stockItem2: 'Збережіть 50% часу',
    stockItem3: 'Зробіть бізнес простим',
    qualityProcessTitle: 'ПРОЦЕС СИСТЕМИ ЯКОСТІ',
    processStep1Title: '1. Перевірка сировини',
    processStep1Item1: 'Контроль хімічного складу сталі',
    processStep1Item2: 'Контроль механічних властивостей сталі',
    processStep1Item3: 'Контроль твердості сталевого листа',
    processStep1Item4: 'Контроль розміру сировини',
    processStep2Title: '2. Передвиробничий огляд',
    processStep2Item1: 'Перевірка розмірів ріжучих деталей',
    processStep3Title: '3. Поточна перевірка',
    processStep3Item1: 'Перевірка процесу зварювання',
    processStep3Item2: 'Перевірка негабаритних товарів',
    processStep3Item3: 'Перевірка високоточних деталей',
    processStep4Title: '4. Перевірка гідравлічних та електричних деталей',
    processStep4Item1: 'Перевірка циліндра перед встановленням',
    processStep4Item2: 'Перевірка двигуна перед встановленням',
    processStep4Item3: 'Перевірка клапана перед встановленням',
    processStep5Title: '5. Перевірка складання',
    processStep5Item1: 'Перевірка процесу складання',
    processStep5Item2: 'Функціональне випробування успішності складання',
    processStep5Item3: 'Перевірка зовнішнього вигляду покриття',
    processStep5Item4: 'Перевірка товщини покриття',
    processStep5Item5: 'Випробування адгезії покриття',
    processStep6Title: '6. Огляд перед поставкою',
    processStep6Item1: 'Перевірка фарбування',
    processStep6Item2: 'Перевірка готовності',
    processStep6Item3: 'Перевірка відповідності індивідуальним вимогам',
    processStep6Item4: 'Тестування перед поставкою',
    processStep6Item5: 'Перевірка упаковки',
